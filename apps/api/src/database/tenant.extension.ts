...
const TENANT_MODELS = ['User', 'AuditEvent', 'Customer', 'Asset', 'ServiceRequest', 'WorkOrder', 'WorkOrderTimelineEvent', 'Diagnosis', 'Estimate', 'Supplier', 'Part', 'InventoryTransaction', 'Invoice', 'Payment'];
